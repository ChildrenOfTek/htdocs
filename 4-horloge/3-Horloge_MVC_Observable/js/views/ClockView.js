...
ClockView.prototype._createElements = function(){ //Fonction de création des éléments composant le rendu 
  ...
  // Append sert à ajouter du contenu à la fin d'un element html, ici dans le body
...
ClockView.prototype.display = function(){ // là on ballance l'affichage apres avoir recuperer ce qu'il faut du modele
